...
Completely disables the AJAX 'cart fragments' feature in WooCommerce for a huge boost in loading speed ('redirect to cart page' is recommended).
...
= 1.0 =
* Initial release based on common issues with our clients
